              ...
              <table class="table table-striped" id='table_id'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('admin.requirement.details',$order->id) }}" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
                            ...
                            <div class="modal-body">
                              <div class="text-center">
                                <div class="row">
                                  ...
                                  <div class="col-md-12">
                                    <form action="{{ route('admin.requirement.delete',$order->id) }}" method="post">
                                      {{csrf_field()}}
