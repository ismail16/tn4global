  ...
  <div class="content-wrapper">
    <div class="row d-flex justify-content-center">
      ...
      <div class="col-md-10 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Edit Bulk Product</h4>
            <form class="forms-sample" method="post" action="{{ route('admin.bulk_product.update', $product->id) }}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <?php
                  $product_images = App\Models\BulkProductImage::where('product_id', $product->id )->get();
...
{{--                        {{$product_image[0]['image']}}--}}
                  ...
                  <div class="col-md-4">
                    ...
                    <img src="{{ asset('images/bulk_product_image/'.$product_image[1]['image']) }}" alt="" width="50px">
                  ...
                  <div class="col-md-4">
                    ...
                    <img src="{{ asset('images/bulk_product_image/'.$product_image[2]['image']) }}" alt="" width="50px">
                  ...
                  <div class="col-md-4">
                    ...
                    <img src="{{ asset('images/bulk_product_image/'.$product_image[3]['image']) }}" alt="" width="50px">
