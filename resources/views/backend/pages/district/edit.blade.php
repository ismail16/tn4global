      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" method="post" action="{{ route('admin.district.update',$district->id) }}" enctype="multipart/form-data">
              @csrf
              <div class="form-group">
                <label for="exampleInputName1">District Name</label>
                <input type="text" name="district_name" value="{{ $district->name }}" class="form-control" id="exampleInputName1" placeholder="District Name">
              </div>
              <div class="form-group">
