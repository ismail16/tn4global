...
<head>
	...
	<link rel="stylesheet" href="{{ asset('public/frontend_assets/style.css')}}">

	<!-- Cusom css -->
   <link rel="stylesheet" href="{{ asset('public/frontend_assets/css/custom.css')}}">
   <link rel="stylesheet" href="{{ asset('public/frontend_assets/css/product.css')}}">
