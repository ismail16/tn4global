								...
								<div class="tab__container mt--2">
									...
									<div class="container">
										<div class="row grid">
											...
											?>
											<div class="col-md-3 col-sm-6 grid-item" data-category="" style="width:50%">
												<div class="product-grid4">
													<div class="product-image4">
														<a href="{{ route('single_bulk_product',$product->id) }}">
															@php
																$image = \App\Models\BulkProductImage::where('product_id',$product->id)->first()->image;
															@endphp

															<img class="pic-1" src="{{ asset('images/bulk_product_image/'.$image)}}">
															<img class="pic-2" src="{{ asset('images/bulk_product_image/'.$image)}}">
														</a>
														<ul class="social">
													...
													<div class="product-content">
														<p class="_title"><a href="{{ route('single_bulk_product',$product->id) }}">{{ $product->title }}</a></p>
														<div class="_price">
															Price -{{ $product->price }}TK
															<!-- <span>$16.00</span> -->
														</div>
														<a class="btn btn-outline-info _cart _add-to-cart" type="submit" name="button">ADD TO CART</a>
